...
Thanks for using `uniprot-mcp-server`. Bugs, feature requests, and documentation gaps all belong in an issue — that's where they get read and picked up.
...
- [Report a bug](https://github.com/cyanheads/uniprot-mcp-server/issues/new?template=bug_report.yml)
- [Request a feature](https://github.com/cyanheads/uniprot-mcp-server/issues/new?template=feature_request.yml)
- [Ask a question or float an idea](https://github.com/cyanheads/uniprot-mcp-server/issues/new) — free-form, no template

I don't take pull requests on this repo — a precise issue with a reproduction is the fastest route to a fix.

## Server bug or framework bug?

`uniprot-mcp-server` is built on [@cyanheads/mcp-ts-core](https://github.com/cyanheads/mcp-ts-core), which handles transports, auth, config, logging, and telemetry. Sorting out which layer broke saves everyone a round-trip:
